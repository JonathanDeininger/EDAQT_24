...
Q_CONSTINIT const QMetaObject MediaController::staticMetaObject = { {
    ...
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMediaControllerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void MediaController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->currentTrackChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        ...
        {
            using _t = void (MediaController::*)(int , const QString & );
            if (_t _q_method = &MediaController::currentTrackChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MediaController::currentTrackChanged(int _t1, const QString & _t2)
{
...
// SIGNAL 1
void MediaController::positionChanged(int _t1)
{
